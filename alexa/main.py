...
class oi():
    ...
    #opção 2 certo
    op2 = Elemento ( img = "https://i.imgur.com/dVn8Gfo.png" , x = 700, y=390, w = 500, tit= "Clique")
    ...
    #opção 1 errado
    op1 = Elemento ( img = "https://i.imgur.com/lN2umME.png", x = 250, y=390, w = 500, tit= "Clique")
